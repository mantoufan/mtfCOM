var Emoji = {
	...
	trans:  function(text) {
		...
		text = text.replace(Emoji.reg, function(code) {
			var e=Emoji._escapeToUtf32(code);
			Emoji.e2code[e]=code;
			return '<img width=' + fontSize + ' class="'+Emoji.c+'" style="vertical-align:middle" src="' + Emoji.emojiPath + e + '.png" emoji="' + e + '">';
		});
